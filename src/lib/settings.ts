 ...
 * Пока это только интервал смены упражнения. Источник истины — профиль на
 * сервере (settings.move_interval_seconds), здесь его кэш: плеер стартует
 * сразу и не ждёт профиля.
 */

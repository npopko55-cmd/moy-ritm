...
#
# Это первое поколение роликов (до 21.09.2026). Нынешние — 3D-маскот —
# собирает scripts/build-loops-v2.py. Запускать этот теперь не нужно: часть id
# совпадает с новыми, и он затёр бы их старыми роликами.
#
